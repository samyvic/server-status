        ...
        <div className="container flex flex-row items-center justify-center text-center
         h-screen w-full relative bg-slate-50 z-0">
            ...
            <form className='w-5/6 shadow-2xl rounded py-20 bg-white flex flex-col items-center'>
                ...
                <p className='my-4'>New to XOrithm ? <Link href="/register" className='text-blue-600'>Register for new Account</Link></p>
                <div className='w-3/4'>
                ...
                <a href={reference} className='w-3/4 border-solid border-white rounded m-2 p-4 text-white
                        bg-blue-600 hover:bg-blue-800 duration-500'>Login</a>
                </button>
