  ...
  return (
    <>
        ...
        h-screen w-full relative bg-slate-50 z-0">
            ...
            <form className='w-5/6 shadow-2xl rounded py-20 bg-white flex flex-col items-center' id="form">
                <h1 className='text-4xl font-bold'>Register</h1>
                <p className='my-4'>Already have and account ? <Link href="/login" className='text-blue-600'>Login</Link></p>
                <div className='w-3/4'>
                    <label className="block text-gray-700 text-sm font-bold mb-2 text-left" htmlFor="Name" >Name</label>
                ...
                <button type="button" onClick={handleRegistration}>
                    <a href={reference} className='w-3/4 border-solid border-white rounded m-2 p-4 text-white
                        bg-blue-600 hover:bg-blue-800 duration-500'>Register</a>
